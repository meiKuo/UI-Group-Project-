...
$(document).ready(() => {
    ...
    if (mushroom1["edible"]){
      document.getElementById("edible1").innerHTML = "Not Toxic"
    }
    else{
      document.getElementById("edible1").innerHTML = "Toxic"
    }
    if (mushroom2["edible"]){
      document.getElementById("edible2").innerHTML = "Not Toxic"
    }
    else{
      document.getElementById("edible2").innerHTML = "Toxic"
    }
