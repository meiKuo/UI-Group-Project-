mushrooms = {
    "0": {
        ...
        "name": "True Morels",
        "edible": True,
        "img_url": 'https://cdn3.vectorstock.com/i/1000x1000/99/27/hand-drawn-colorful-morel-mushroom-vector-27769927.jpg',
    ...
    "7": {
        ...
        "inner": "White", 
        "description": "Oyster mushrooms, the common name for the species Pleurotus ostreatus, are one of the most common types of cultivated mushrooms in the world. They're also known as pearl oyster mushrooms or tree oyster mushrooms. The funghi grow naturally on and near trees in temperate and subtropic forests around the world, and they're grown commercially in many countries. Oyster mushrooms are eaten in a variety of cuisines and are especially popular in Chinese, Japanese, and Korean cooking. They can be dried and are typically eaten cooked.", 
    },
    "8": {
        "id": "8",
        "name": "Lion's Mane",
        "edible": True,
        "img_url": 'https://image.shutterstock.com/z/stock-vector-lion-s-mane-mushroom-hericium-erinaceus-edible-and-medicinal-plant-hand-drawn-botanical-vector-1328148566.jpg',
        "cut_img_url": "images/puffball_mushroom_open_1.png",
        "cap": "Distinctive shape that resembles mane of a male lion or a pom pom", 
        "stem": "Pure white stems", 
...
lessons = [
    ...
    {
        "lesson_id": "3", 
        "lesson_name": "Puff Ball vs Destroying Angel", 
        "mushroom1": "2",
        "mushroom2": "3" , 
        "type": "compare", 
    }, 
